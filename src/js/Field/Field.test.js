...
describe('Класс Field', () => {
    ...
    it('Проверка работы move(down) #1', () => {
        const field = new Field(4, Tile.merge, Tile.compare);
        field.setCell(0, 0, new Tile(2));
        field.setCell(0, 1, new Tile(2));
        field.move('down');
    ...
    it('Проверка работы move(down) #2', () => {
        const field = new Field(4, Tile.merge, Tile.compare);
        field.setCell(0, 0, new Tile(2));
        field.setCell(0, 1, new Tile(4));
        field.setCell(2, 0, new Tile(2));
        field.setCell(2, 1, new Tile(2));
        field.move('down');
    ...
    it('Проверка работы move(down) #3', () => {
        const field = new Field(4, Tile.merge, Tile.compare);
        field.setCell(0, 0, new Tile(2));
        field.setCell(1, 0, new Tile(2));
        field.setCell(2, 0, new Tile(2));
        field.setCell(3, 0, new Tile(2));
        field.move('down');
    ...
    it('Проверка работы move(down) #4', () => {
        const field = new Field(4, Tile.merge, Tile.compare);
        field.setCell(0, 0, new Tile(2));
        field.setCell(1, 0, new Tile(4));
        field.setCell(2, 0, new Tile(2));
        field.setCell(3, 0, new Tile(4));
        field.move('down');
